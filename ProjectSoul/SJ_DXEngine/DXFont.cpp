...
void CDXFont::DrawString(const wchar_t* _Text,const float& _FontSize, const Vec2& _Pos, const Vec4& Color,const FW1_TEXT_FLAG& _Align /*= FW1_TEXT_FLAG::FW1_TOP*/)
{
	if (nullptr == m_pFontWrapper)
		return;

	
	m_pFontWrapper->DrawString(DXCONTEXT, _Text, _FontSize, _Pos.x, _Pos.y, Color.GetARGB(), _Align);
